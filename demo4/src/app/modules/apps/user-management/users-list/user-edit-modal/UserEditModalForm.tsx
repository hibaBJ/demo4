      ...
      <form id='kt_modal_add_user_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        ...
        >
          ...
          <div className="mb-10">
              ...
              <div className="mb-10">
                <label className="required fw-bold fs-6 mb-2">Pays</label>
                  <input
                    type="text"
                    className="form-control form-control-solid"
              ...
              <div className="mb-10">
                <label className="required fw-bold fs-6 mb-2">Ville</label>
                  <input
                    type="text"
                    className="form-control form-control-solid"
          ...
          <div className='mb-7'>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_0'>
                  <div className='fw-bolder text-gray-800'>Administrateur</div>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_1'>
                  <div className='fw-bolder text-gray-800'>Dévélopeur</div>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                {/* begin::Label */}
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_3'>
                  <div className='fw-bolder text-gray-800'>Ingénieur Logiciel</div>
            ...
            <div className='d-flex fv-row'>
              ...
              <div className='form-check form-check-custom form-check-solid'>
                ...
                <label className='form-check-label' htmlFor='kt_modal_update_role_option_4'>
                  <div className='fw-bolder text-gray-800'>Technicien réseau</div>
        ...
        <div className='text-center pt-15'>
          ...
          >
            <span className='indicator-label'>Sauvgarder</span>
